...
/// Implements Contemporary Community Trust design system with Hyperlocal Warmth color palette.
class AppTheme {
  AppTheme._();

  // Primary color palette - Hyperlocal Warmth
  static const Color primaryLight = Color(0xFF2B5A87); // Deep community blue
  static const Color primaryDark =
      Color(0xFF4A7BA7); // Lighter blue for dark mode
  static const Color secondaryLight = Color(0xFFE8734A); // Warm accent
  static const Color secondaryDark = Color(0xFFE8734A); // Same warm accent

  // Semantic colors
  static const Color successLight = Color(0xFF4A7C59); // Muted green
  static const Color successDark = Color(0xFF5A8C69);
  static const Color warningLight = Color(0xFFD4A574); // Sophisticated amber
  static const Color warningDark = Color(0xFFD4A574);
  static const Color errorLight = Color(0xFFB85450); // Restrained red
  static const Color errorDark = Color(0xFFC86460);
  ...
  // Outline colors
  static const Color outlineLight = Color(0xFFE1E5E9); // Minimal border color
  static const Color outlineDark = Color(0xFF3C4043);

  // Additional colors for community features
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme with community trust aesthetics
    ...
    // Form input theme with security-focused design
    ...
    // Interactive elements with community trust indicators
    ...
    // List tile theme for community feed
  ...
  /// Dark theme with community warmth preserved
